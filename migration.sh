...
for project in "d:/OpenRewritePlayground/src/main/"; do
  ...
  if [ -d "$project" ]; then
    ...
    mod run --recipe org.openrewrite.java.migrate.jakarta.JavaxMigrationToJakarta --repository-path = d:/OpenRewritePlayground/src/main/
  else
